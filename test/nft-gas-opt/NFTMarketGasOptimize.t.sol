...
contract NFTMarketGasOptimizeTest is Test {
    NFTMarketGasOptimize public market;
    ...
    function setUp() public {
        ...
        // 部署NFT市场合约
        market = new NFTMarketGasOptimize(address(paymentToken));
        ...
        vm.label(address(market), "NFTMarketGasOptimize");
    }
    ...
    function testListNFTSuccess() public {
        ...
        emit NFTMarketGasOptimize.NFTListed(0, seller, address(nftContract), tokenId, price);
    ...
    function testListNFTFailureZeroPrice() public {
        ...
        // 预期会失败，并显示特定错误
        vm.expectRevert(NFTMarketGasOptimize.NFTMarket__InvalidPrice.selector);
    ...
    function testListNFTFailureZeroAddress() public {
        ...
        // 预期会失败，并显示特定错误
        vm.expectRevert(NFTMarketGasOptimize.NFTMarket__InvalidNFTContractAddress.selector);
    ...
    function testBuyNFTSuccess() public {
        ...
        // 预期会发出NFTSold事件
        vm.expectEmit(true, true, true, true);
        emit NFTMarketGasOptimize.NFTSold(listingId, buyer, seller, address(nftContract), tokenId, price);
    ...
    function testBuySelfNFT() public {
        ...
        // 预期会发出NFTSold事件
        vm.expectEmit(true, true, true, true);
        emit NFTMarketGasOptimize.NFTSold(listingId, seller, seller, address(nftContract), tokenId, price);
    ...
    function testBuyNFTTwice() public {
        ...
        // 尝试再次购买同一个NFT，预期会失败
        vm.expectRevert(NFTMarketGasOptimize.NFTMarket__ListingNotActive.selector);
        market.buyNFT(listingId);
    ...
    function testBuyNFTInsufficientBalance() public {
        ...
        // 尝试购买NFT，预期会失败
        vm.expectRevert(NFTMarketGasOptimize.NFTMarket__InsufficientTokenBalance.selector);
        market.buyNFT(listingId);
    ...
    function testBuyNFTWithCallbackIncorrectAmount() public {
        ...
        vm.expectRevert(NFTMarketGasOptimize.NFTMarket__IncorrectPaymentAmount.selector);
    ...
    function testFuzz_ListAndBuyNFT(uint256 fuzzPrice, address fuzzBuyer) public {
        ...
        // 预期会发出NFTSold事件
        vm.expectEmit(true, true, true, true);
        emit NFTMarketGasOptimize.NFTSold(listingId, fuzzBuyer, seller, address(nftContract), tokenId, listingPrice);
